...
("fig", "fig07_growth_adjusted.png",
 "Figure 7. Growth-adjusted multiples: Databricks (19.4x / +80%) versus Snowflake (15.3x / +31% FY27 guide). Sources: Databricks per company disclosures (T2, Jun 16, 2026) and Feb 2026 mark; Snowflake per 8-K of May 27, 2026 (T1) and market data of Jul 7, 2026. Iso-value rays indicate equal price per growth point; no fitted line is shown."),
...
("fig", "fig08_absorption.png",
 "Figure 8. The absorption question: AI mega-listing values versus 2025 US IPO issuance. Sources: SpaceX listing and performance (T3, Jun-Jul 2026); OpenAI target and Anthropic mark (T2/T3, Mar-May 2026); raise estimates (T3, desk aggregation); 2025 US IPO proceeds $44-47B (Deloitte, EY, T2)."),
...
("fig", "fig09_football_field.png",
 "Figure 9. Valuation football field, 12-month view. The base case reaches the rumored range on fundamentals alone; the rumor is a reference line, not an input. Sources: as tabled above."),

("p", "The sensitivity grid (Figure 10) makes the machinery inspectable: value is forward run-rate times multiple, and the base intersection ($11.5 billion at 14 to 16x) sits comfortably above the current mark even after a five-point multiple de-rate. Read the bear column honestly: at $9.5 billion (growth halving) and 12x, the implied $114 billion sits 15% below the current mark, which is what the position risks if the margin gate breaks and growth decelerates simultaneously. Read the discipline the other way too: today's 19.4x on the base-case run-rate would imply roughly $223 billion, and we are deliberately not underwriting today's private multiple surviving the listing. The margin of safety is not the multiple; it is the per-point spread and the cohort-worst price for cohort-best quality."),

("fig", "fig10_sensitivity.png",
 "Figure 10. Sensitivity: implied valuation across mid-2027E run-rate and multiple, base intersection highlighted. Desk estimates, July 10, 2026."),
]
