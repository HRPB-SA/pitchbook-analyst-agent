...
| LB05b | Anthropic Q2-2026 ADJUSTED operating income | 559 (projection; sign confirmed; ≈ 5.1% adjusted margin on 10,900) | $M | Q2-2026 | non-GAAP adjusted operating income; definition unpublished; per T3 relays includes training cost, excludes SBC; not an operating profit, not FCF (Ruling 3) | confirmed (sign) / estimated (amount, definition) | T2 / T3 | QUARTERLY | L-034, L-151, L-152 | 04, 11 |
| A03 | Anthropic Q1-2026 revenue | 4,730 | $M | Q1-2026 | recognized, GROSS presumed (Bloomberg full text); replaces the derived ~5,000 (L-129) | confirmed | T2 | QUARTERLY | L-151 | 02, 03, 04 |
| A19 | Anthropic compute cost per revenue dollar | 0.71 (Q1-2026) → 0.56 (Q2-2026 projected) | ratio | H1-2026 | T4 relay; implies 29% → 44% gross-basis GM only if compute is the whole of cost of revenue; display and cross-check only, never a driver | estimated | T4 | QUARTERLY | L-152 | 03 (cross-check), 11 (CE-2 note) |
| A20 | Google Cloud commitment, reported value | 200,000 over five years (= 40,000 per year) | $M | 2026-05-05 | The Information via Reuters; page not opened; Alphabet 10-Q, Google release, Broadcom 10-Q silent on $ and take-or-pay (L-153, L-154, L-156) | estimated | T3 [VERIFY] | STABLE | L-155 | 09 (SW_GOOGLE_VALUE branch only; never in documented-$) |
| A21 | Filing silences (text) | Alphabet 10-Q: 0 Anthropic mentions, 811,000 total purchase commitments (200,700 short-term); Google release: no $; Broadcom 10-Q: no customer commitment, top-5 ≈ 45% of revenue; Microsoft 10-K: no revenue-share %, no 250,000 | text | 2026 | disclosure checks | confirmed | T1 | STABLE | L-153, L-154, L-156, L-157 | 09, 13 (display) |
| A22 | $15B facility closing status | NOT closed as of 2026-09-09 ("set to finalize" Sep-3; PB deal still Upcoming) | status | 2026-09-09 | house rule: [VERIFY] until closed | could-not-verify | T3 | STABLE once closed | L-160 | 05, 11 (SW_15B_FACILITY default) |
...
| A11 | Anthropic debt facilities | revolver 2,500; expansion 15,000 "set to finalize" (Sep-3), NOT closed as of Sep-9 | $M | 2025-05-16 / 2026-09-03 / 2026-09-09 | facilities | confirmed / estimated / could-not-verify | T2 / T3 / T3 | STABLE | L-014, L-042, L-160 | 05 (SW_15B_FACILITY, default does not close) |
...
| A15 | Comp anchors | MTS base 1.12 and 1.38 per person; MTS range 0.134-1.38; MTS Manager to 0.85; Technical Sales 0.156-0.50; Product Design Manager 0.14-0.385; ~80 H-1B roles; T4 bands 0.30-0.76 | $M/yr | 2026-06-28 | base only (verbatim relay) / total comp (T4) | estimated | T3 / T4 | QUARTERLY | L-165 (supersedes L-092) | 03 (L5, AJ) |
...
| O09 | Retention bonuses | ~1.5 per person × ~1,000, >1,500 total over 2 yrs; engineers 0.2-0.6, key researchers "mid-single-digit millions", paid quarterly over two years | $M | 2025-08 | The Information relay; verbatim not reachable (403) | estimated / could-not-verify | T3 | STABLE | L-093, L-166 | 03 (L5) |
| O10 | OpenAI debt | 4,000 + 700 + 520 = 5,220 | $M | 2026-07-08 | facilities | confirmed | T2 | STABLE | L-023 | 05 |
| O11 | Microsoft terms | rev share through 2030 at same % subject to cap (no % in the 10-K; Bloomberg full text states no basis for the >40,000); cap 38,000 (T3); stake at the Oct-2025 recap ~27% (~135,000) / Foundation 26% / investors and employees 47% (T2), post-dilution decreased and undisclosed; RPO 678,000 (+25% ex-OpenAI); Azure 250,000 could-not-verify | mixed | 2026-04-27 / 2026-05-11 / 2025-10-28 / 2026-06-30 | official / single-outlet / TechCrunch / 10-K / CNV | mixed | T1 / T3 / T2 / T1 / T4 | STABLE | L-051, L-052, L-159, L-158, L-054, L-055, L-121 | 09, 10 |
| O13 | Microsoft funding commitments to OpenAI | 13,000 committed; 11,900 funded at 2026-06-30 (= PB 1,000 + 2,000 + 10,000; 1,100 unfunded) | $M | 2026-06-30 | 10-K equity-method note; CE denominator keeps PB's committed basis (the 1,100 is 0.6% of LB04: 0.221x → 0.222x if stripped, within rounding) | confirmed | T1 | STABLE | L-157 | 05 (note cell), 09, 10 |
...
| X01 | Neocloud lease economics | Nscale 16.3; Volta 12.5; Riot 2.4; Hut 8 Beacon Point 1.86 (15-yr, 704 MW, 19,600 base-term; tenant Nvidia); Core Scientific-AMD 1.76; TPU SPV chips-only 6.9; Google reported value implies 8.0 at 5 GW (2.5 at 16 GW) | $M per MW-yr | 2026-08 | derived | estimated | T3 / T1 | VOLATILE | L-134, L-136, L-167, L-148, L-044, L-155 | 09 (SW_TPU_RATE, SW_GOOGLE_VALUE), 07 |
...
| B01 | Growth endurance (SaaS base rate) | growth retained year to year ~70% (private cloud) / ~80% (public cloud); i.e. next year's growth = 0.7 × this year's | % | 2021-09-21 (published benchmark) | Bessemer; SaaS dataset, not consumption-billed labs | estimated | T3 | PERMANENT | L-161 | 00 (Anthropic 2029E-2030E tails), 13 |
| B02 | Capex-heavy platform margin path (AWS operating margin) | 9.9 (2014) · 19.1 (2015) · 25.4 (2016) · 24.8 (2017) · 28.4 (2018) · 26.3 (2019) · 29.8 (2020) · 29.8 (2021) · 28.5 (2022) · 27.1 (2023) · 37.0 (2024) · 35.4 (2025) | % | FY2014-FY2025 | four Amazon 10-Ks (segment tables); operating margin, not gross margin | confirmed | T1 | PERMANENT | L-162 | 13 |
| B03 | IPO timing base rate | no filed-to-priced or withdrawal statistic available (PB none; Renaissance paywall; SEC counts only); colour: median step-up 1.3x at listing (Q2-2026); Cerebras cancel → refile → price ~9 months | status | 2026-08-10 | analyst judgment for slippage, with one documented case | could-not-verify | T2 (colour) | STABLE | L-163 | 13 |
...
- AJ drivers (yellow): Anthropic monthly run-rate ramp shape H2-2026 (linear to YE expectation low / mid / high: 100,000 / 110,000 / 120,000; Bear = flat from July); Anthropic 2027E revenue (Bear 120,000 / Base 145,000 / Bull 160,000; AJ interpolation, no row); Anthropic 2028E revenue (Bear 150,000 / Base 190,000 / Bull 220,000; L-036 low end at Base, AJ shortfall in Bear, AJ beat in Bull); Anthropic 2029E-2030E revenue growth = Bessemer endurance (B01) applied to each scenario's 2028 growth rate: growth(2029) = endurance × growth(2028); growth(2030) = endurance × growth(2029), with endurance 0.70 in Bear and Base (private) and 0.80 in Bull (public, post-IPO). Arithmetic to reproduce: Bear +25.0% (2028) → +17.5% → +12.2% = 176,250 / 197,841; Base +31.0% → +21.7% → +15.2% = 231,276 / 266,446; Bull +37.5% → +30.0% → +24.0% = 286,000 / 354,640. Note cell: the same rule applied to FY2026E growth (+476% on the PB FY2025 10,000) would give +333% in 2027 and ~249,356 of revenue, above the company's 2028 plan, which is why the base rate shapes only the tails (AM-71); Anthropic GM 2026 (44 / 52 / 60), 2029E-2030E GM (Bear 65 / Base 72 / Bull 77, AJ); Anthropic training 2029E-2030E (Bear 40,000 / Base 30,000 / Bull 25,000, AJ); Anthropic quarterly opex Q2-2026 for the GM cross-check (3,000 / 4,000 / 5,000); Anthropic average loaded cash comp per head (0.75 / 0.60 / 0.50 $M); Azure term (5 yrs, AJ); Lambda term (6 yrs, AJ); SpaceX ramp discount May-Jun 2026 (0.9 factor, AJ); Google TPU $/MW-yr proxy (via SW_TPU_RATE); OpenAI H2-2026 monthly growth (Bear 0% / Base 10% / Bull 20%); OpenAI 2027-2030 revenue CAGR (40 / 70 / 100%); OpenAI compute plan (900,000 / 750,000 / 600,000: Bear is the higher spend); OpenAI 2027-2030 opex ex-compute as % of revenue (Bear 40 / Base 30 / Bull 20, AJ); OpenAI 2030E training (Bear 120,000 / Base 90,000 / Bull 60,000; AJ, no row); SBC as % of operating loss for the burn bridge (AJ 25 / 20 / 15).
...
- FY2026E integration, Anthropic: Q3 = July monthly (LB01/12) + Aug + Sep on the linear ramp to the YE expectation chosen by SW_SCEN; Q4 likewise; FY2026E = A03 + LB05a + Q3 + Q4 with A03 = 4,730 (L-151). Check cell: must reproduce 57,580 / 62,580 (YE 100,000 / 120,000) and 48,830 (flat); H1-2026 = 16,330; Q2/Q1 = 2.45x.
...
- Q2 GM cross-check grid (A45:K60 with `04_PL` A30:H40): rows opex 3,000 / 4,000 / 5,000; columns basis GROSS / NET-39.75 / NET-27; cell = (LB05b + opex) / Q2 revenue on that basis, with a header note that LB05b is a non-GAAP adjusted operating income (excludes SBC per relays), so the implied GM is an adjusted GM. Check: 31% / 51% at 3,000 gross / net-39.75. Second cross-check row from A19: 1 − 0.56 = 44% gross-basis if compute is all of cost of revenue; and 1 − 0.56 − SW_HAIRCUT = 4.25% (39.75%) or 17% (27%) if partner payouts sat beside it: a consistency flag cell, red if below the opex ratio.
- Unit-economics block: list prices A18 (display); no $/token COGS (L-116: none disclosed), cell reads "HOLE".

### 3.4 `04_PL`
- Both companies, D:K: revenue (gross and net rows for Anthropic), COGS (L4), gross profit, GM%, training (L3), other opex (L5), operating result excl-training and incl-training. 2023A-2025A cells link to the few ledger facts (A05, A06, O01, O02, LB06) and otherwise read HOLE. 2026E: Anthropic Q2 actual block (LB05a, LB05b labelled "adjusted operating income, non-GAAP") with H1 recognized = 16,330 (A03 4,730 + LB05a 11,600; ≈ 16,230 on the >11,500 print); OpenAI H1 block (LB06a, LB06b).
...
- Burn walk: OpenAI O05 both vintages; bridge from operating loss (LB06b annualized) to burn = operating loss − SBC (AJ %) − vendor financing / prepayment timing (plug, yellow, labelled HOLE). Anthropic: C-12 block (SW_A_2026_LOSS) showing branch A (−11,000 GAAP loss, L-120) and branch B (Q2 positive adjusted operating income trajectory, L-034, L-151; non-GAAP, definition unpublished, L-152); no plug. Facilities block: revolver 2,500 drawn/undrawn HOLE; 15,000 expansion shown only when SW_15B_FACILITY = "Closes" (default: "Does not close", L-160).
...
- $/AIBQ-point ladder (A25:F32): M01 / composite(new) and M02 / composite(new) from `11_AIBQ`; old row at 8.20 / 4.53. Check: 118 / 175 ($B per point) at the default (facility does not close); 119 / 175 and 1.47x on the facility-closes branch; spread 1.48x (old 1.60x). No cell computes any correlation; sheet-level note: "Ruling 2: correlation embargoed".
...
- Envelope chart data (A80:K95): Anthropic COGS + training envelope by year from `03_Costs`; priced run from above; unpriced proxy = (Google unpriced GW by year: 2026 0 (the ~1 GW Ironwood sits inside the SPV), 2027 5 (contracted tranche, L-073/L-049), 2028 = SW_GW_2028 (5 = contracted tranche only / 15 = plus Broadcom's 10 GW line of sight, L-049)) × SW_TPU_RATE × 1,000 + AMD (2 GW from 2027 at the same rate, AJ). Google leg = IF(SW_GOOGLE_VALUE = "reported", 40,000 per year from 2027, the proxy above). Gap row = envelope − priced − Google leg − AMD proxy. Checks: reported branch (default for E10's first band): 2027 gap = 65,800-69,500 − 47,730 − 40,000 = −18,230 to −21,930; 2028 gap = 65,700-68,000 − 93,355 = −25,355 to −27,655 (before AMD; Broadcom's line of sight treated as inside the reported figure, conservative for the gap). Proxy branch at Base (SW_TPU_RATE = 9.3, SW_GW_2028 = 5): 2028 gap ≈ −33,000; at SW_GW_2028 = 15: ≈ −126,000; at SW_TPU_RATE = 12.5 the two gaps are ≈ −49,000 and ≈ −174,000. Consistency cell: 200,000 / 5 / (GW × 1,000) = 8.0 at 5 GW and 2.5 at 16 GW ($M per MW-yr), printed beside the chip-only SPV rate 6.9.

### 3.10 `10_Financing`
- Ladder rows F01-F09: instrument, lab, rate or terms, risk holder, row, tier (from `analysis/cost-stack-reconciliation.md` §6). Spread cell = 9.0-9.75% neocloud (L-059) minus 5.75% SPV A2 (L-044) = 325-400 bp; annual value on 34,500 = 1,121-1,380 (formula). Backstop register: Nvidia RVG 105,000 (L-061), Nvidia Lambda lease at Hut 8 Beacon Point (L-137; L-167: 15-yr landlord lease, 704 MW tenant capacity, 19,600 base-term value, 50,200 with renewals, ≈ 1.86 per MW-yr; row F10), Broadcom/Google SPV support 30,000 (L-044), Google project-debt support (L-045), AMD DC lease guarantees 4,100 and leases 9,500 (L-146), SB Energy warrant charge 2,573 (L-147), Microsoft recap gain 6,500 (L-054), Huang statement (L-075, text).

### 3.11 `11_AIBQ`
- Table exactly as `analysis/aibq-delta.md` §1-§4: sub-score, weight, old, new, rubric band text, rows, type, Δ raw, Δ dim = weight × Δ raw, flag (≥0.5). Dimension = SUMPRODUCT(weights, new). Composite Δ = 0.20 × ΔCE + 0.15 × ΔCI. New composite = canonical old (8.20 / 4.53) + Δ. Checks: Anthropic CE 7.375 (CE-4 = 7.5 at the default SW_15B_FACILITY = "Does not close"; 7.30 with CE-4 = 7.0 if it closes), CI 5.55, composite 8.15 (8.13 on the closes branch; 8.04 on the CI-5.8 base, shown); OpenAI CE 3.925, CI 5.60, composite 4.87 (4.79 gross case via SW_OAI_BASIS, which drives CE-1 = 5.0 / 4.0). Efficiency Index cells: Anthropic 0.55; OpenAI 0.50. Label cell beside CE-3: "positive adjusted operating income, non-GAAP (L-151, L-152)".

### 3.12 `12_Conflicts` (§5 below)

### 3.13 `13_OutsideView`
- One row per forecast: forecast, reference class, base rate, base-rate source (row or "AJ"), what is different here, magnitude, direction. Rows per `analysis/outline-v5.md` §10 and `writer-brief.md` §10. Sourced rows: growth decay = B01 (L-161, T3, SaaS caveat in the note column); margin path = B02 (L-162, T1; operating margin, printed beside Anthropic's GROSS-margin plan with a basis note); IPO slippage = B03 (L-163, could-not-verify; "analyst judgment" in the source column with the Cerebras case in the note). AM-71 arithmetic cell: 57,580 / 10,000 − 1 = +476%; × 0.7 = +333%; 57,580 × 4.33 = 249,356 vs the 190,000-200,000 plan.
...
| Anthropic 2027E revenue | 120,000 | 145,000 | 160,000 | AJ (between L-035 and L-036) |
| Anthropic 2028E revenue | 150,000 | 190,000 | 220,000 | L-036 (T2) at Base; Bear is an AJ shortfall; Bull an AJ beat |
| Anthropic 2029E / 2030E revenue | 176,250 / 197,841 (endurance 0.70) | 231,276 / 266,446 (0.70) | 286,000 / 354,640 (0.80) | B01 Bessemer endurance on the 2028 growth rate (L-161, T3, SaaS caveat) |
| Google leg value | proxy 16.3 per MW-yr (SW_GOOGLE_VALUE = proxy) | reported 40,000 per year [VERIFY] (SW_GOOGLE_VALUE = reported) | proxy 6.9 per MW-yr | L-155 (T3); L-134, L-044 |
...
| C10 | SW_A_2026_LOSS | C-12 (with addendum) | "GAAP −11,000 (Jan plan)" / "Adjusted-operating-income trajectory (Q2 print; non-GAAP, definition unpublished, L-151/L-152)" | Q2 print | `05_Cash_Fund` Anthropic 2026 burn block; `04_PL` 2026 note row |
...
| C14 | SW_15B_FACILITY | (L-042, L-160: not closed as of Sep-9) | "Closes" / "Does not close" | **Does not close** (house rule: [VERIFY] until closed) | `05_Cash_Fund` facilities; `11_AIBQ` CE-4 (closes 7.0 / does not close 7.5; neither returns to the prior 8.0 because the lease stack drives the score) |
| C17 | SW_GOOGLE_VALUE | C-14 addendum (Google leg) | "reported" (40,000 per year 2027-2031, L-155, T3 [VERIFY]) / "proxy" (GW × SW_TPU_RATE, GW from SW_GW_2028) | reported (Base) | `09_Obligations` Google leg column and reported-$ total; E10 band; grid (b); never documented-$ |
...
(b) A25:H40 **Anthropic envelope grid (2028E).** Rows: revenue 150,000 / 175,000 / 200,000. Columns: GM 60% / 70% / 77%. Cell = revenue × (1 − GM) + training 22,000 − priced run 53,355 − Google leg (40,000 if SW_GOOGLE_VALUE = reported, else SW_TPU_RATE × SW_GW_2028 × 1,000). Negative = the plan does not cover the commitments. Expected at (200,000, 77%, reported): 46,000 + 22,000 − 53,355 − 40,000 = −25,355. Print a second panel with training at 30,000 and a third with SW_GOOGLE_VALUE = proxy.
...
| G10 | Colocation / powered shell | wholesale ~100-150 per kW-month triple-net; Core Scientific-AMD ≈ 147 per kW-month (= 1.76M per MW-yr, 2.5% escalators, 15 yrs); Hut 8 Beacon Point ≈ 155 per kW-month (= 1.86M per MW-yr; 15-yr, 704 MW, 19,600 base-term, 50,200 with renewals; tenant Nvidia); Riot ≈ 2.4M per MW-yr (20 yrs); retail 180-400 (T4) | $ per kW-month; $M per MW-yr | L-110 · T3; L-148 · T1; L-167 · T1; L-136 · T2 | |
...
| G20 | Tokens per second per GPU, by model class (switch `SW_GF_MODELCLASS`: MoE-efficient / dense-frontier) | MoE-efficient: SGLang on GB200 NVL72, DeepSeek V3/R1, 13,386 output tok/s/GPU (26,156 input; 2,000-token inputs; FP8 attention + NVFP4 MoE; 9,087 / 18,471 at BF16/FP8); MLPerf v5.1 GB300 NVL72 DeepSeek-R1 5,842 offline / 2,907 server. Dense-frontier: GB200 NVL72 Llama 3.1 405B 224 offline / 170 server / 138 interactive. Serving cost per million output tokens = GPU-hr rate ÷ (tok/s × 3,600 × utilization) × 1,000,000. Derived at 100% utilization: MoE (13,386 → 48.2M tok/GPU-hr) $0.22 at on-demand 10.50 (G02, L-104), $0.05-0.08 at contracted 2.40-4.00 (G03, L-105); MoE server-mode GB300 (2,907 → 10.5M) $1.00 on-demand, $0.23-0.38 contracted; dense 405B (138-224 → 0.50-0.81M) $13-21 on-demand, $3.0-8.1 contracted. At 60% utilization multiply by 1.67 | tokens/s/GPU; $ per M tokens | L-164 · confirmed · T2 (throughput); L-104 · T1; L-105 · T3 | Frontier proprietary models are not benchmarked; the dense-405B case is the closer proxy for them (flag). The Writer may print a $/MTok as an ESTIMATE with the throughput, the rate and the utilization in the sentence |
| G21 | Researcher comp bands | top-decile leaders: 25-100M per year over 4 yrs at the extreme (Meta: "$100M over four years not inconceivable"; up to $300M/4 yrs reported); senior IC total comp 0.5-1.5M (T4); Anthropic H-1B base (verbatim relay): MTS 1.12M and 1.38M, MTS range 0.134-1.38M, MTS Manager to 0.85M, Technical Sales 0.156-0.50M, Product Design Manager 0.14-0.385M, ~80 roles; engineers total comp 0.30-0.76M (T4) | $M/yr | L-094 · T2; L-165 · T3 (supersedes L-092) | Base only for the H-1B rows; equity excluded |
| G22 | Retention | ~1.5M per person × ~1,000 over 2 yrs (>1,500 total); structure per search-level relays: engineers 0.2-0.6M, key researchers "mid-single-digit millions", quarterly over two years in cash and/or stock | $M | L-093 · estimated · T3; L-166 · could-not-verify · T3 | Verbatim not reachable (403); keep T3 / CNV |
...
| Inference serving | cost per MTok from G20 (L-164 anchors) at G07 40-70% utilization, model class per `SW_GF_MODELCLASS` (Lean default: MoE-efficient, $0.05-0.08 contracted at 100% → $0.08-0.20 at 40-70%); revenue at G19 list less AJ 30-50% discounting; inference cost as % of revenue path 64% (Y1, G18 anchor) → 45% (Y3) → 35% (Y5) AJ | same path; default dense-frontier class ($3.0-8.1 contracted at 100% → $4-20 at 40-70%); 64% → 40% → 30% | same, with ASIC "half cost" from Y5 (flagged vendor claim) |
...
| Anthropic (incumbent, for scale) | equity 124,254; documented contracts 324,100 (reported-$ 524,100 incl. the unverified Google leg) | run-rate 65,000 gross; Q1 4,730, Q2 11,600; first positive adjusted operating income (non-GAAP) | 5,000 | 965,000 | beyond 2 | L-007, L-032, L-151, L-033, L-034, L-152, L-155, L-008, L-005 |
...
| E10 | A / 09_Obligations / A80:K95 | envelope chart data; Google band via SW_GOOGLE_VALUE (reported 40,000/yr [VERIFY] or proxy via SW_TPU_RATE × SW_GW_2028) |
...
2. Reproduction checks (Base, defaults): Anthropic net run-rate 39,162; multiples 14.8x / 24.6x / 20.3x; OpenAI 21.3x; CE 0.315 / 0.382 / 0.221; ratio 1.43x; FY2026E integrations 57,580 / 62,580 / 48,830 and 32,400 / 38,119 / 45,500 (H1 Anthropic 16,330); documented-$ 324,100 / 358,600 / 480,400 / 690,000; reported-$ 524,100 [VERIFY]; Bloomberg tally 175,000; annualized Anthropic 2028 priced run ≈ 53,355; Google leg reported 40,000 per year (2028 stack 93,355; gap −25,355 to −27,655); OpenAI 2027 priced run ≈ 110,083; AIBQ CE 7.375 / 3.925 (7.30 if SW_15B_FACILITY = Closes), CI 5.55 / 5.60, composites 8.15 / 4.87 (8.13 branch); $/pt 118 / 175 (119 branch), spread 1.48x (1.47x branch); envelope 2028 65,700-68,000; Bessemer tails 176,250 / 197,841, 231,276 / 266,446, 286,000 / 354,640; G20 serving cost 0.22 (MoE, on-demand) and 13-21 (dense, on-demand).
...
11. The reported Google value (A20) never feeds a cell labelled "documented"; every cell that reads it carries the [VERIFY] text in the adjacent column; the CE-4 cell prints both facility branches; LB05b's label contains the word "adjusted" wherever it is displayed.
