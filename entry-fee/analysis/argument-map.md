...
| 5 | Anthropic Q2-2026 revenue and first positive ADJUSTED operating income | $11.5-11.6B revenue (Q1 $4,730M); adjusted operating income projected $559M ≈ 5.1% adjusted margin on $10.9B, sign confirmed | Q2-2026 (reported Aug-14/17/19) | Recognized quarterly revenue, preliminary, GROSS presumed; the profit measure is non-GAAP "adjusted operating income" (Bloomberg), definition not published; per T3 relays it includes model-training cost and excludes SBC; WSJ: "the methodology behind the adjusted profitability measure is unclear" | L-033, L-034, L-151, L-152 | confirmed (revenue, sign) / estimated (margin, definition) | T2 (T3 for the definition) | The strongest counter-evidence to the thesis, weaker than v4-era reporting implied; CE-3; the GM cross-check; C-12 |
...
Tier note: none of the ten is T1 except #8 and #9. The run-rates (#1, #2) are company-to-investor communications relayed by T2 outlets; the Q2 prints (#5, #6) are leaked to Bloomberg/WSJ/Reuters and #5's profit measure is non-GAAP with an unpublished definition; the equity sums (#3, #4) are derived from PitchBook deal records. Second pass (L-150 to L-168): Bloomberg's full text adds Q1-2026 revenue $4,730M (T2) and lifts the Q2-2025 comparator $787M from T4 to T2 (L-151, supersedes L-143); Microsoft's 10-K adds $13.0B committed / $11.9B funded (L-157, T1). The S-1s will replace #1-#6 with audited figures. The report must say so once, in the methodology box, and not apologize for it on every page.
...
|---|---|---|---|---|---|
| AM-01 | Standing at the frontier has cost $124.3B (Anthropic) and $181.2B (OpenAI) of equity, before any debt or lease; the two labs have signed documented compute contracts of $324B (Anthropic, eight counterparties) and $480B (OpenAI, four counterparties) on top; a reported but unverified ~$200B five-year Google Cloud commitment (The Information, T3, page not opened) would take Anthropic's reported-$ to $524B | L-007, L-022, L-072, L-074, L-046, L-076, L-135, L-137, L-048, L-136, L-064, L-058, L-149, L-155 | T3 (Volta L-048 inside the $324B; press-valued Oracle/AWS inside the $480B at T2) | A public S-1 showing materially smaller purchase obligations in the commitments note | KWF (state "documented-$, scope in Exhibit 5") |
...
| AM-04 | The thesis is weaker than in v4 at the adjusted-operating-income level (Anthropic Q2: a non-GAAP measure excluding SBC with an unpublished definition, projected at $559M or ~5.1% of revenue) and stronger at the commitment level (both) | L-034, L-151, L-152, L-066, L-062, L-138 | T3 (the definition of "adjusted") | Anthropic's H2-2026 or FY2026 adjusted result turning negative, or the S-1 showing a GAAP operating loss for Q2, would restore v4; OpenAI's operating loss narrowing QoQ would weaken v5 | KWF (say "adjusted" and "definition unpublished" in the sentence) |
...
| AM-08 | Anthropic FY2026E gross recognized revenue is $57.6-62.6B on a linear ramp from the July run-rate to the $100-120B year-end expectation (Q1 $4.73B, Q2 $11.6B, H1 ≈ $16.3B), $48.8B if flat from July; PB's $65B is a projection at the top of that range | L-032, L-033, L-151, L-035, L-010 | T3 (L-035 investor expectation) | The S-1's FY2026 revenue outside $49-65B | KWF (label "derived, investor expectation, not guidance") |
...
| AM-11 | Anthropic's 2026 compute spend cannot be stated on a basis comparable with OpenAI's $50B; the only comparable objects are the Q2 print, the T4 compute-cost ratio ($0.71 → $0.56 per revenue dollar) and the derived COGS envelope ($23-35B); the Reuters full text confirms no company figure exists | L-128, L-150, L-152, L-078, L-034, L-119 | could-not-verify (L-128) | The S-1 cost of revenue and R&D lines | KWF (print the HOLE) |
...
| AM-33 | Anthropic's Q2 adjusted operating income implies gross-basis GM of 31-48% (net-basis 51-80%) for AJ quarterly opex of $3-5B, and the T4 compute-cost ratio ($0.56 per revenue dollar) implies ~44% gross-basis if compute is the whole of cost of revenue: the GM band a reader sees depends on the reporting basis, not only on the business. Corollary (both legs T4): a 39.75% partner payout cannot sit in cost of revenue beside a $0.56 compute ratio (gross margin would be 4%), so either the ratio already contains the payouts or the effective payout share is below 39.75% | L-034, L-151, L-152, L-033, L-126 | T3/T4 (definition and ratio) | The S-1 income statement | KWF (label the opex assumption and the adjusted measure) |

### §5 The margin-commitment incompatibility (new)

| ID | Claim | Rows | Weakest | Falsifier | Status |
|---|---|---|---|---|---|
| AM-34 | On Anthropic's own 2028 plan (revenue $190-200B, GM 77%, training $22B) the annual compute envelope is ~$66-68B; priced commitments already run ~$53B in 2028; the unpriced Google TPU (5 GW contracted, 10 GW more in vendor line of sight) and AMD 2 GW deals are the largest items: three branches for the Google leg: at the reported ~$200B over five years ($40B/yr, The Information, T3, [VERIFY]) the 2028 stack is ~$93B against the ~$66-68B envelope, an excess of $25-28B/yr before AMD and before Broadcom's line of sight; on the $/MW-yr proxy the contracted 5 GW alone exceeds the remainder by $30-50B/yr, and the 2028 line of sight would take the excess to $125-175B/yr; Alphabet, Google and Broadcom disclose no dollar value or take-or-pay terms in their filings; one of {77% GM, $22B training, take-or-pay status of the GW deals} is untrue | L-036, L-119, L-125, L-072, L-074, L-046, L-135, L-048, L-136, L-137, L-044, L-049, L-043, L-134, L-155, L-153, L-154, L-156 | T4 (L-119, L-125); T3 [VERIFY] (L-155) | The S-1 commitments note showing the GW deals as options or consumption-based; or a GM path below 77%; or a training budget above $22B | KWF (the report's "next mispricing"; present as a conditional with the three exits) |
| AM-35 | Full-stack GPU capacity prices at ~$12-16M per MW-yr (Nscale, Volta) versus ~$1.8-2.4M for powered shell (Core Scientific-AMD $1.76M, Hut 8 Beacon Point $1.86M, Riot $2.4M); the TPU SPV implies ~$6.9M per MW-yr for chips alone; the reported Google value implies ~$8.0M per MW-yr at 5 GW | L-134, L-135, L-048, L-148, L-167, L-136, L-044, L-155 | T3 (derived; L-167 anchor is T1) | Published lease terms | KWF |
...
| AM-43 | At the Oct-2025 recap Microsoft held ~27% (~$135B), the Foundation 26% and investors and employees 47% (T2); after the March round the stake is below 27% and undisclosed ("our proportionate ownership of OpenAI decreased"); Microsoft's funding commitments total $13.0B, of which $11.9B was funded at Jun-30-2026, reconciling PitchBook's $1B + $2B + $10B exactly with $1.1B of the 2023 tranche unfunded | L-054, L-157, L-159, C-19 addendum | T2 (the 27%; post-dilution % is a silence) | S-1 cap table | KWF (print "~27% at the recap; below 27% now, undisclosed") |
...
| ID | Claim | Rows | Weakest | Falsifier | Status |
|---|---|---|---|---|---|
| AM-50 | Re-run on the rubric, Anthropic CE moves 8.0 → 7.4 (composite −0.125; 7.3 and −0.14 if the $15B facility closes) and CI 5.05 → 5.55 (+0.075); OpenAI CE 3.05 → 3.9 (+0.175) and CI 4.5 → 5.6 (+0.165); composites 8.20 → 8.15 (8.13 branch) and 4.53 → 4.87; tiers unchanged | `analysis/aibq-delta.md`; L-133 and rows therein | T4 (CE-2 GM; the prior sub-scores) | NEXUS re-score disagreeing on a logged event | KWF (flag the method-driven CE-1 move) |
| AM-51 | The $/AIBQ-point ladder narrows from 1.60x to 1.48x (OpenAI $175B/pt vs Anthropic $118B/pt; 1.47x and $119B/pt if the $15B facility closes) | L-005, L-019, L-160, aibq-delta §5 | T4 | New marks | KWF |
...
| AM-56 | Two of the three base rates the report needs now have sources: software growth endurance (~70% of the prior year's growth rate retained for private cloud companies, ~80% public; a SaaS dataset, not consumption-billed labs) and the capex-heavy platform margin path (AWS operating margin 9.9% in 2014 → 25.4% in 2016 → 27-30% in 2018-2023 → 37.0% / 35.4% in 2024-2025, four Amazon 10-Ks). IPO-window slippage has no statistic (PitchBook, Renaissance, SEC: none); the one documented frontier-adjacent case is Cerebras (confidential file → cancel → refile → price ~9 months later) and the report labels the slippage base rate "analyst judgment" | L-161, L-162, L-163 | T3 (L-161); T1 (L-162); could-not-verify (L-163) | A published filed-to-priced statistic | KWF (label the SaaS caveat and the IPO base rate as analyst judgment) |
...
| AM-64 | Top-decile researcher packages price at $25-100M per year over four years at the extreme; base salaries for Anthropic's Member of Technical Staff roles run $134K to $1.38M with two entries at $1.12M and $1.38M (~80 H-1B roles, base only); OpenAI's 2025 retention program paid engineers $200-600K and key researchers "mid-single-digit millions" over two years, >$1.5B in total (verbatim not reachable) | L-094, L-165, L-166 | T3 (L-165 verbatim relay; L-166 could-not-verify) | n/a | KWF |
...
| AM-70 | Alphabet, Google, Broadcom and Microsoft disclose no dollar value for the Anthropic TPU commitment, the OpenAI custom-silicon program or the Azure commitment in their filings, and no revenue-share percentage or run-rate basis appears in Microsoft's 10-K or Bloomberg's full text: for a report about disclosure, the silence is itself the finding | L-153, L-154, L-156, L-157, L-158, L-121 | T1 (the silences are checked in the filings) | Any of the four filing the number | KEEP |
| AM-71 | The SaaS growth-endurance base rate cannot generate a bear case for Anthropic on its own: applied to FY2026E growth (+476% on PitchBook's FY2025 $10B), 70% endurance gives +333% in 2027 and ~$249B of revenue, above the company's own $190-200B 2028 plan; the plan already embeds a faster decay than the base rate, so the bear risk is a regime break (consumption revenue, price compression), not base-rate decay; the base rate shapes only the 2029-2030 tail of each scenario | L-161, L-151, L-010, L-036 | T3 (L-161) | A published AI-lab growth-decay dataset | KWF (label the SaaS caveat) |
| AM-72 | A current-generation serving stack yields ~48M output tokens per GPU-hour on an efficient MoE model (SGLang on GB200 NVL72, DeepSeek V3/R1), which is ~$0.22 per million output tokens at CoreWeave's on-demand $10.50 per GPU-hour and $0.05-0.08 at contracted $2.40-4.00, at 100% utilization; dense frontier-class models run 60-100x slower (Llama 3.1 405B: 138-224 tokens/s/GPU), or ~$13-21 per million on-demand and ~$3-8 contracted; list prices of $5-50 per million output tokens sit above the dense band and far above the MoE band | L-164, L-104, L-105, L-084 | T2 (L-164; L-105 is T3) | A provider disclosing $/MTok COGS | KWF (print the throughput, the rate and the utilization in the sentence; it is an estimate) |
| AM-73 | Anthropic's $15B revolver expansion had not closed as of Sep-9 (Bloomberg: "set to finalize"; PitchBook: still "Upcoming"); under the house rule it is [VERIFY], so the debt block and CE-4 carry it as "does not close" by default | L-160, L-042 | could-not-verify (T3) | A closing report | KWF |
...
| "First quarterly operating profit" (v4-era phrasing carried into the first v5 package) | The measure is ADJUSTED operating income, non-GAAP, definition unpublished (L-151, L-152) | "first positive adjusted operating income" with the definition caveat in the same sentence |
...
C-02 (residual: Q4-2026 vs 2027 for OpenAI's IPO) · C-03 (Anthropic FY2025 recognized: PB $10B vs implied $4.5-6B) · C-05 (Anthropic FY2024 net loss −$5.3B vs −$8.3B) · C-08 (SSI round size) · C-12 (Anthropic 2026 loss/burn definitions and vintage; addendum: the positive Q2 figure is a non-GAAP adjusted measure whose scope the company has not published, L-151/L-152) · C-13 (39.75% vs ~27%; the L-152 compute ratio is a T4 datapoint against the internal branch, see AM-33) · C-15 (secondary marks) · C-16 (OpenAI run-rate basis) · C-18 (Anthropic headcount 5,000 vs ~4,020). Resolved by the ledger and stated as resolved: C-01 (classification), C-04 (artifact; both figures dropped), C-06 (vintage), C-07 (T1 governs), C-09 (minor), C-10 (PB date artifact), C-11 (basis label), C-14 (scope table; addendum: the Google leg's reported ~$200B/5 yr is a T3 [VERIFY] row that roughly doubles every published tally if included, L-155), C-17 (company statement governs), C-19 (range statement; addendum: the recap 27% / 26% / 47% is now T2, L-159, and the post-dilution % is a documented silence, L-157), C-20 (supersession), O-15 Altman title (PB artifact, L-028/L-070/L-089).
