...
("p", "The correlation coefficient linking business quality to valuation across our coverage cohort is embargoed and appears nowhere in this document, in text or in chart form. The only cleared public expression of the quality-valuation relationship is the dollar-per-AIBQ-point spread, presented as a ranked bar (Figure 1). No chart in this note plots quality scores against valuations, and no chart carries a fitted line from which the embargoed statistic could be reconstructed."),

("h3", "Valuation basis"),
("p", "The base-case valuation anchors on the last completed financing mark of $134 billion (Series L, first close announced December 2025, additional close February 9, 2026; T2, company press releases and PitchBook deal record 313367-68T). The reported financing discussions at $165 to 175 billion (T3: The Information, June 9, 2026) remained unclosed as of July 10, 2026 and are excluded from the base case under our do-not-adopt rule for unclosed or rumored financings. They are analyzed, at length, in Section 10. Capital-efficiency calculations use an equity-only denominator; debt is excluded from that ratio by methodological ruling and informs the compute-independence and risk assessments instead (Appendix A)."),

("p", "This document is research, not investment advice. Databricks securities are not publicly traded; private-market access is restricted, illiquid, and unsuitable for investors who cannot bear total loss and indefinite holding periods. Figures for private peers are negotiated marks, not market prices."),
...
("bullets", [
  ...
  "The price. At $15.2 billion per AIBQ point, the market charges less for Databricks quality than for any other asset in the cohort (Figure 1). Growth-adjusted against its nearest public comp, the discount repeats: Databricks trades at 0.24x forward revenue multiple per point of growth versus Snowflake at 0.49x (Figure 3). Two independent yardsticks, private and public, say the same thing.",
]),
...
("fig", "fig04_radar.png",
 "Figure 4. AIBQ dimension scores, Databricks versus Frontier Five average, July 2026. Cohort dimension averages are desk estimates consistent with published composites (8.81 / 8.20 / 4.53 / 4.49 / 2.30). Source: desk AIBQ framework."),
]
