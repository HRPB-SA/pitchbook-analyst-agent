...
("table", {
  ...
  "align": "LLLLL",
  "source": "Estimates, July 21, 2026. Reference lines: $134B completed mark (Feb 9, 2026); $188B announced round (signed, unclosed; company, Jul 16, 2026). Base multiple is a deliberate de-rate from today's 19.4x toward public hypergrowth-platform pricing.",
}),
...
("table", {
  ...
  "rows": [
    ...
    ["6", "Mark confusion", "Unclosed rounds and thin secondary trading can anchor expectations the fundamentals then have to chase; this report's do-not-adopt rule exists for that reason", "Close, repricing, or death of the announced $188B round (expected summer 2026)"],
